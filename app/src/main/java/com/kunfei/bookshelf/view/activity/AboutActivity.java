...
public class AboutActivity extends MBaseActivity {
    ...
    private String[] allQQ = new String[]{"小棉袄推荐", "(HikerQQ群)787676325", "(HikerQQ群)422780191", "(阅读QQ群)701903217", "(阅读QQ群)805192012"};
